...
INSERT INTO app_user (id, email, phone, password_hash, full_name, guest) VALUES
...
INSERT INTO otp_challenge (id, user_id, channel, code_hash, expires_at, consumed, attempt_count) VALUES
...
INSERT INTO delivery_center (id, name, latitude, longitude, address_line, service_area_geo) VALUES
('c0000003-0000-0000-0000-000000000001', 'SoMa Hub', 37.7785, -122.4056, '123 Brannan St, San Francisco, CA 94107', '{"type":"Polygon","coordinates":[[[-122.42,37.77],[-122.39,37.77],[-122.39,37.79],[-122.42,37.79],[-122.42,37.77]]]}'),
('c0000003-0000-0000-0000-000000000002', 'Mission Hub', 37.7599, -122.4148, '456 Valencia St, San Francisco, CA 94110', '{"type":"Polygon","coordinates":[[[-122.43,37.75],[-122.40,37.75],[-122.40,37.77],[-122.43,37.77],[-122.43,37.75]]]}'),
('c0000003-0000-0000-0000-000000000003', 'Castro Hub', 37.7609, -122.4350, '789 Market St, San Francisco, CA 94114', '{"type":"Polygon","coordinates":[[[-122.45,37.75],[-122.42,37.75],[-122.42,37.77],[-122.45,37.77],[-122.45,37.75]]]}');

INSERT INTO fleet_vehicle (id, center_id, vehicle_type, available, external_device_id) VALUES
...
INSERT INTO orders (
    ...
    pickup_summary, dropoff_summary, handoff_pin, estimated_minutes,
    total_amount, currency, sim_latitude, sim_longitude, sim_heading_deg,
    sim_updated_at, plan_snapshot, tracking_state
) VALUES
('e0000005-0000-0000-0000-000000000001', 'a0000001-0000-0000-0000-000000000001', 'c0000003-0000-0000-0000-000000000001', 'd0000004-0000-0000-0000-000000000001', 'DELIVERED', 'DRONE', '37 Main St, San Francisco, CA', '88 Folsom St, San Francisco, CA', '4821', 18, 12.50, 'USD', 37.7850, -122.3985, 92.5, NOW() - INTERVAL '2 hours', '{"route":"SoMa-direct","distanceKm":1.2}', '{"lastEvent":"DELIVERED","deliveredAt":"2026-03-25T08:00:00Z"}'),
('e0000005-0000-0000-0000-000000000002', 'a0000001-0000-0000-0000-000000000002', 'c0000003-0000-0000-0000-000000000002', 'd0000004-0000-0000-0000-000000000006', 'IN_TRANSIT', 'ROBOT', '200 Valencia St, San Francisco, CA', '500 Guerrero St, San Francisco, CA', '7743', 25, 9.75, 'USD', 37.7612, -122.4201, 180.0, NOW() - INTERVAL '5 minutes', '{"route":"Mission-loop","distanceKm":0.8}', '{"lastEvent":"PICKED_UP"}'),
('e0000005-0000-0000-0000-000000000003', 'a0000001-0000-0000-0000-000000000003', 'c0000003-0000-0000-0000-000000000003', NULL, 'PENDING', 'DRONE', '100 Castro St, San Francisco, CA', '300 Noe St, San Francisco, CA', NULL, 20, 14.00, 'USD', NULL, NULL, NULL, NULL, NULL, NULL),
('e0000005-0000-0000-0000-000000000004', 'a0000001-0000-0000-0000-000000000004', 'c0000003-0000-0000-0000-000000000001', NULL, 'CANCELLED', 'ROBOT', '50 Brannan St, San Francisco, CA', '150 King St, San Francisco, CA', NULL, NULL, 0.00, 'USD', NULL, NULL, NULL, NULL, NULL, '{"lastEvent":"CANCELLED","reason":"payment_failed"}');

INSERT INTO order_parcel (id, order_id, size_tier, weight_kg, fragile, delivery_notes, dimensions) VALUES
('f0000006-0000-0000-0000-000000000001', 'e0000005-0000-0000-0000-000000000001', 'S', 0.500, FALSE, NULL, '{"lengthCm":15,"widthCm":10,"heightCm":8}'),
('f0000006-0000-0000-0000-000000000002', 'e0000005-0000-0000-0000-000000000002', 'M', 1.200, TRUE, 'Handle with care - glassware', '{"lengthCm":25,"widthCm":20,"heightCm":15}'),
('f0000006-0000-0000-0000-000000000003', 'e0000005-0000-0000-0000-000000000003', 'L', 2.800, FALSE, 'Leave at door', '{"lengthCm":40,"widthCm":30,"heightCm":20}'),
('f0000006-0000-0000-0000-000000000004', 'e0000005-0000-0000-0000-000000000004', 'S', 0.300, FALSE, NULL, '{"lengthCm":12,"widthCm":8,"heightCm":6}');

INSERT INTO payment (id, order_id, stripe_payment_intent_id, status, amount, currency, idempotency_key, provider_payload) VALUES
('70000007-0000-0000-0000-000000000001', 'e0000005-0000-0000-0000-000000000001', 'pi_test_alice_succeeded', 'SUCCEEDED', 12.50, 'USD', 'idem-alice-ord-001', '{"receiptUrl":"https://pay.stripe.com/receipts/test_alice"}'),
('70000007-0000-0000-0000-000000000002', 'e0000005-0000-0000-0000-000000000002', 'pi_test_bob_pending', 'PENDING', 9.75, 'USD', 'idem-bob-ord-002', '{}'),
('70000007-0000-0000-0000-000000000003', 'e0000005-0000-0000-0000-000000000003', NULL, 'PENDING', 14.00, 'USD', 'idem-carol-ord-003', '{}'),
('70000007-0000-0000-0000-000000000004', 'e0000005-0000-0000-0000-000000000004', 'pi_test_guest_failed', 'FAILED', 0.00, 'USD', 'idem-guest-ord-004', '{"failureCode":"card_declined"}');
